...
export function Header() {
    return (
        <header className="bg-white border-b border-[var(--color-gray-200)] px-6 py-4 sticky top-0 z-50">
            <div className="max-w-[1280px] mx-auto flex items-center justify-between gap-4">
                ...
                <nav className="hidden md:flex items-center gap-2">
                    <a
                        href="#"
                        className="px-4 py-2 text-sm font-medium bg-[var(--color-primary-50)] text-[var(--color-primary-700)] rounded-md no-underline"
                    >
                        Dashboard
                    </a>
                    <a
                        href="#"
                        className="px-4 py-2 text-sm font-medium text-[var(--color-gray-600)] hover:bg-[var(--color-gray-100)] hover:text-[var(--color-gray-900)] rounded-md transition-colors no-underline"
                    >
                        Patients
                    </a>
                    <a
